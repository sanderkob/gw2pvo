...
def decode_mqtt(telegram):
    ...
    # print("Meter Reading Export High Tariff:", meter_reading_export_high_tariff)
    ...
    meter_data = {"Date:" : date, 
                ...
                "Meter Reading Export High Tariff" : meter_reading_export_high_tariff,
...
def returndata(telegram, telegram_midnight):
    ...
    import_energy = (meter["Meter Reading Import High Tariff"] - 
                     meter_midnight["Meter Reading Import High Tariff"] +
                     meter["Meter Reading Import Low Tariff"] - 
                     meter_midnight["Meter Reading Import Low Tariff"]
    )         
    import_power = meter["Import power"]
    export_energy = (meter["Meter Reading Export High Tariff"] - 
                    meter_midnight["Meter Reading Export High Tariff"] +
                    meter["Meter Reading Export Low Tariff"] - 
                    meter_midnight["Meter Reading Export Low Tariff"]
    )   
    export_power = meter["Export power"]
